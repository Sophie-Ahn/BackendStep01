...
//        model.put("memberDao", this.getServletContext().getAttribute("memberDao"));
        ...
        try {
            ...
            if ("/memberDi/list.do".equals(servletPath)){
//                pageController = new MemberListController();

            } else if("/memberDi/add.do".equals(servletPath)){
//                pageController = new MemberAddController();
            ...
            } else if("/memberDi/update.do".equals(servletPath)){
//                pageController = new MemberUpdateController();
            ...
            } else if("/memberDi/delete.do".equals(servletPath)){
//                pageController = new MemberDeleteController();
                model.put("no", Integer.parseInt(req.getParameter("no")));

            } else if("/authDi/login.do".equals(servletPath)){
//                pageController = new LoginController();
            ...
            } else if("/authDi/logout.do".equals(servletPath)){
