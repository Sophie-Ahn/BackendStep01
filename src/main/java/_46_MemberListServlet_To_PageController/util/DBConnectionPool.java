package _46_MemberListServlet_To_PageController.util;
...
public class DBConnectionPool {
    ...
    public Connection getConnection() throws Exception {
        ...
        // 위의 return conn;이 되지 않았다는 것은 정상적인 Connection객체가 없거나, 정상적이지 않다는 뜻이므로 새롭게 서버와 연결된 Connection 객체를 생성해서 return한다.
