...
public class DispatchServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if ("/memberPageCont/list.do".equals(servletPath)){
                pageControllerPath = "/memberPageCont/list";
            } else if("memberPageCont/add.do".equals(servletPath)){
                pageControllerPath = "/memberPageCont/add";
            ...
            } else if("memberPageCont/update.do".equals(servletPath)){
                pageControllerPath = "/memberPageCont/update";
                if(req.getParameter("email") != null){
                    req.setAttribute("member", new Member()
            ...
            } else if("memberPageCont/delete.do".equals(servletPath)){
                pageControllerPath = "/memberPageCont/delete";
            } else if("authPageCont/login.do".equals(servletPath)){
                pageControllerPath = "/authPageCont/login";
            } else if("authPageCont/logout.do".equals(servletPath)){
                pageControllerPath = "/authPageCont/logout";
            }
