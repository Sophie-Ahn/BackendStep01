package _52_Question.servlet;

import _52_Question.controls.*;
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        */
        ...
        try {
            ...
            if ("/memberQController/list.do".equals(servletPath)){
                // 기존에 Servlet을 호출하던 구조에서 일반 Java객체를 호출하는 방식으로 변경
//                pageControllerPath = "/memberController/list";
                pageController = new MemberListController();

            } else if("/memberQController/add.do".equals(servletPath)){
...
//                }
            ...
            } else if("/memberQController/update.do".equals(servletPath)){
...
//                }
            ...
            } else if("/memberQController/delete.do".equals(servletPath)){
//                pageControllerPath = "/memberController/delete";
                pageController = new MemberDeleteController();
                model.put("no", Integer.parseInt(req.getParameter("no")));
            } else if("/authQController/login.do".equals(servletPath)){
//                pageControllerPath = "/authController/login";
            ...
            } else if("/authQController/logout.do".equals(servletPath)){
