...
public class DispatchServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if ("/memberDispatch/list.do".equals(servletPath)){
                pageControllerPath = "/memberDispatch/list";
            } else if("memberDispatch/add.do".equals(servletPath)){
                pageControllerPath = "/memberDispatch/add";
            ...
            } else if("memberDispatch/update.do".equals(servletPath)){
                pageControllerPath = "/memberDispatch/update";
                if(req.getParameter("email") != null){
                    req.setAttribute("member", new Member()
            ...
            } else if("memberDispatch/delete.do".equals(servletPath)){
                pageControllerPath = "/memberDispatch/delete";
            } else if("authDispatch/login.do".equals(servletPath)){
                pageControllerPath = "/authDispatch/login";
            } else if("authDispatch/logout.do".equals(servletPath)){
                pageControllerPath = "/authDispatch/logout";
            }
