...
public class DispatchServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if ("/memberlink/list.do".equals(servletPath)){
                pageControllerPath = "/memberlink/list";
            } else if("/memberlink/add.do".equals(servletPath)){
                pageControllerPath = "/memberlink/add";
                if(req.getParameter("email") != null){
                    req.setAttribute("member", new _48_Question.vo.Member()
                            .setEmail(req.getParameter("email"))
                            .setPassword(req.getParameter("password"))
                            .setName(req.getParameter("name")));
                }
            } else if("/memberlink/update.do".equals(servletPath)){
                pageControllerPath = "/memberlink/update";
                if(req.getParameter("email") != null){
                    req.setAttribute("member", new _48_Question.vo.Member()
            ...
            } else if("/memberlink/delete.do".equals(servletPath)){
                pageControllerPath = "/memberlink/delete";
            } else if("/authlink/login.do".equals(servletPath)){
                pageControllerPath = "/authlink/login";
            } else if("/authlink/logout.do".equals(servletPath)){
                pageControllerPath = "/authlink/logout";
            }
