...
import _50_MemberListController.controls.Controller;
import _50_MemberListController.controls.MemberListController;
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        */
        ...
        try {
            ...
            if ("/memberController/list.do".equals(servletPath)){
                // 기존에 Servlet을 호출하던 구조에서 일반 Java객체를 호출하는 방식으로 변경
//                pageControllerPath = "/memberController/list";
                pageController = new MemberListController();

            } else if("/memberController/add.do".equals(servletPath)){
            ...
            } else if("/memberController/update.do".equals(servletPath)){
                pageControllerPath = "/memberController/update";
                if(req.getParameter("email") != null){
                    req.setAttribute("member", new Member()
            ...
            } else if("/memberController/delete.do".equals(servletPath)){
                pageControllerPath = "/memberController/delete";
            } else if("/authController/login.do".equals(servletPath)){
                pageControllerPath = "/authController/login";
            } else if("/authController/logout.do".equals(servletPath)){
                pageControllerPath = "/authController/logout";
            }
