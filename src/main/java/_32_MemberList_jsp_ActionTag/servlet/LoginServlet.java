package _32_MemberList_jsp_ActionTag.servlet;

import _32_MemberList_jsp_ActionTag.vo.Member;
...
@WebServlet("/authActionTag/login")
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            if (rs.next()){
                ...
                resp.sendRedirect("../memberActionTag/list");
            } else {
