...
public class DispatchServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if ("/membercontr/list.do".equals(servletPath)){
                pageControllerPath = "/membercontr/list";
            } else if("/membercontr/add.do".equals(servletPath)){
                pageControllerPath = "/membercontr/add";
            ...
            } else if("/membercontr/update.do".equals(servletPath)){
                pageControllerPath = "/membercontr/update";
                if(req.getParameter("email") != null){
                    req.setAttribute("member", new Member()
            ...
            } else if("/membercontr/delete.do".equals(servletPath)){
                pageControllerPath = "/membercontr/delete";
            } else if("/authcontr/login.do".equals(servletPath)){
                pageControllerPath = "/authcontr/login";
            } else if("/authcontr/logout.do".equals(servletPath)){
                pageControllerPath = "/authcontr/logout";
            }
